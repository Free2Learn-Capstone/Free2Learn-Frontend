...
const PrivacyPolicyPage = () => {
  return (
    <div>
      ...
      <p>
        This privacy policy outlines how Free2Learn collects, uses, and protects
        any information that you provide when using our online class platform.
      </p>
      ...
      <p>
        ...
        with a better service. We may use the information for the following
        purposes:
      </p>
      <ul>
      ...
      <p>
        ...
        These third-party sites have their own privacy policies, and we do not
        have control over their practices. Therefore, we cannot be responsible
        for the protection and privacy of any information you provide while
        visiting such sites. We recommend exercising caution and reviewing the
        privacy policies of those third-party sites before providing any
